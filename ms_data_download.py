...
from good_morning.good_download import DB_NAME
...
def test_download():
    for yielder in [  vaid_hk_ticker_yielder(),vaid_techboard_ticker_yielder(),vaid_b_ticker_yielder()]:
